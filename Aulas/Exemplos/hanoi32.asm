...
hanoi:	
	...
	push	dword [ebp+dest]	; quarto param: pino temporario
	push    dword [ebp+temp]	; terceiro param: pino destino
	push    dword [ebp+origem]	; segundo param: pino de origem
